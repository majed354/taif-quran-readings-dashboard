...
# --- إعدادات الصفحة ---
st.set_page_config(
    page_title="ماجستير القراءات | قسم القراءات",
    page_icon="📜",
    layout="wide"
)
...
st.markdown("<h1>📜 ماجستير القراءات</h1>", unsafe_allow_html=True)
...
# if not ("ماجستير_القراءات" == "هيئة_التدريس" or "ماجستير_القراءات" == "إنجاز_المهام" or "master_readings" is not None):
#     st.write(f"محتوى صفحة 'ماجستير القراءات' قيد الإنشاء.")
