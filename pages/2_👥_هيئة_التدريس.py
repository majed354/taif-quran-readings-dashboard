...
# =========================================
    ...
    with main_tabs[0]:
        st.info("محتوى قائمة الأعضاء سيضاف لاحقاً")
    with main_tabs[1]:
        st.info("محتوى التوزيعات سيضاف لاحقاً")
    with main_tabs[2]:
        st.info("محتوى البحوث سيضاف لاحقاً")


# مثال لمحتوى بديل إذا لم تكن هناك تبويبات
# if not ("هيئة_التدريس" == "هيئة_التدريس" or "هيئة_التدريس" == "إنجاز_المهام" or "None" is not None):
#     st.write(f"محتوى صفحة 'هيئة التدريس' قيد الإنشاء.")
