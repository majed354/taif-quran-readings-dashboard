...
st.markdown("<h1>📘 دكتوراه القراءات</h1>", unsafe_allow_html=True)
...
# if not ("دكتوراه_القراءات" == "هيئة_التدريس" or "دكتوراه_القراءات" == "إنجاز_المهام" or "phd_readings" is not None):
#     st.write(f"محتوى صفحة 'دكتوراه القراءات' قيد الإنشاء.")
