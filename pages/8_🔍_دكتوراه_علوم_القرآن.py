...
# --- إعدادات الصفحة ---
st.set_page_config(
    page_title="دكتوراه علوم القرآن | قسم القراءات",
    page_icon="🔍",
    layout="wide"
)
...
st.markdown("<h1>🔍 دكتوراه علوم القرآن</h1>", unsafe_allow_html=True)
...
# if not ("دكتوراه_علوم_القرآن" == "هيئة_التدريس" or "دكتوراه_علوم_القرآن" == "إنجاز_المهام" or "phd_quran" is not None):
#     st.write(f"محتوى صفحة 'دكتوراه علوم القرآن' قيد الإنشاء.")
