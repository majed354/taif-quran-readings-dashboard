...
# --- إعدادات الصفحة ---
st.set_page_config(
    page_title="بكالوريوس القراءات | قسم القراءات",
    page_icon="📖",
    layout="wide"
)
...
st.markdown("<h1>📖 بكالوريوس القراءات</h1>", unsafe_allow_html=True)
...
# if not ("بكالوريوس_القراءات" == "هيئة_التدريس" or "بكالوريوس_القراءات" == "إنجاز_المهام" or "bachelor_readings" is not None):
#     st.write(f"محتوى صفحة 'بكالوريوس القراءات' قيد الإنشاء.")
