...
# --- إعدادات الصفحة ---
st.set_page_config(
    page_title="بكالوريوس القرآن وعلومه | قسم القراءات",
    page_icon="📚",
    layout="wide"
)
...
st.markdown("<h1>📚 بكالوريوس القرآن وعلومه</h1>", unsafe_allow_html=True)
...
# if not ("بكالوريوس_القرآن_وعلومه" == "هيئة_التدريس" or "بكالوريوس_القرآن_وعلومه" == "إنجاز_المهام" or "bachelor_quran" is not None):
#     st.write(f"محتوى صفحة 'بكالوريوس القرآن وعلومه' قيد الإنشاء.")
